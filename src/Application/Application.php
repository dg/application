...
class Application
{
	...
	public function processRequest(Request $request)
	{
		...
		$isForward = $request->isMethod($request::FORWARD);
		if (!$isForward && strcasecmp($request->getPresenterName(), $this->errorPresenter) === 0) {
		...
		try {
			...
			throw $isForward ? $e : new BadRequestException($e->getMessage(), 0, $e);
		}
